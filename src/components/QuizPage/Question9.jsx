...
const Question9 = ({ onAnswer }) => {
  ...
  return (
    <div>
      <p className="text-center mb-4 text-2xl font-bold">Bạn có thường xuyên bật chế độ đang hoạt động trên các diễn đàn cộng đồng không?</p>
