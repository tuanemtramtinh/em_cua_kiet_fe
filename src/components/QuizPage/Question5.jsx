...
const Question5 = ({ onAnswer }) => {
  ...
  return (
    <div>
      <p className="text-center mb-4 text-2xl font-bold">Thời gian bạn dành cho việc kết nối bạn bè trên không gian số có chiếm đa phần thời gian của bạn không?</p>
