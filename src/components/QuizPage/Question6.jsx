...
const Question6 = ({ onAnswer }) => {
  ...
  return (
    <div>
      <p className="text-center mb-4 text-2xl font-bold">Bạn có cảm thấy bạn dành nhiều thời gian trên không gian số hơn ở thế giới thật không?</p>
